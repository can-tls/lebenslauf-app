            ...
            <div className="cv">
                <aside className="sidebar">
                    ...
                    <section>
                        ...
                        <div className="info-item">
                            ...
                            <div>
                                ...
                                <p>
                                    Urbanstraße 48 D<br />Berlin, 10967
                                </p>
                            </div>
                        </div>
                    ...
                    <section>
                        ...
                        <div className="skill"><span>Ruby on Rails</span><span>★★★★★</span></div>
                        <div className="skill"><span>React</span><span>★★★★★</span></div>
                        <div className="skill"><span>C#/.Net</span><span>★★★★★</span></div>
                        <div className="skill"><span>Angular</span><span>★★★★☆</span></div>
                        <div className="skill"><span>Typescript</span><span>★★★★☆</span></div>
                        <div className="skill"><span>MongoDB</span><span>★★★★☆</span></div>
                        <div className="skill"><span>NodeJS</span><span>★★★☆☆</span></div>
                        <div className="skill"><span>PostgreSQL</span><span>★★★★☆</span></div>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="hobby-text">
                            Fotografieren, Zeichnen, Fitness, Klavier, Tischtennis, Bowling, Billard
                        </p>
                    </section>
                </aside>
                ...
                <main className="content">
                    <header>
                        <h1>CAN TALAS</h1>
                        <p>Engagierter Fullstack Developer mit 4 Jahren Erfahrung in der Programmierung.</p>
                        <p>Ich bin erfahren in allen Aspekten des Lebenszyklus der Softwareentwicklung.</p>
                        <p>
                            Meine Absicht ist es, eine langfristige Stelle in einem modernen
                    ...
                    <section className="timeline-section">
                        ...
                        <div className="timeline">
                            <div className="entry">
                                <div className="date">Dez. 2021 - Juni 2022</div>
                            ...
                            <div className="entry">
                                <div className="date">März 2023 - Gegenwärtig</div>
                                <div className="details">
                            ...
                            <div className="entry">
                                <div className="date">Juni 2022 - Gegenwärtig</div>
                                <div className="details">
                                    <h4>Selbstständig</h4>
                    ...
                    <section className="timeline-section">
                        ...
                        <div className="timeline">
                            <div className="entry">
                                <div className="date">Juni 2015 - Juni 2018</div>
                                <div className="details">
                            ...
                            <div className="entry">
                                <div className="date">Sep. 2019 - Juli 2021</div>
                                <div className="details">
                                    <h4>Fachinformatiker Anwendungsentwicklung</h4>
                                    <span>JustRelate GmbH, Berlin</span>
                                    <p>
                                        Ausbildung in Ruby on Rails, React, PostgreSQL, AWS, REST APIs,
                                        TDD und Clean Code.
                                    </p>
                                    <p>(abgeschlossen)</p>
                                </div>
